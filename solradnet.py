...
def plotdiario(opcao):
    ...
    planilha = './DADOS/SolRad-Net/' + str(ano) + '/' + str(ano) + format(mes, '02d') + format(diainicial, '02d')+ '_' + str(ano) + format(mes, '02d') + format(diafinal, '02d') + '_' + sigla + '_py_ALLPOINTS.lev10'
...
def plotmensal(opcao):
    ...
    print('Concluido: ' + str(mes) + ', ' + str(ano))
